...
> ⚠️ **Nota:**  
> Chicos, id añadiendo aquí las tareas que tengamos que realizar para llevar un control.  
> Incluid también tareas individuales si es necesario.  
> ✅ Borrad la tarea cuando esté terminada.
...
- [✅] Pintar el contenido en la página `reservation-details.ejs`:
  ...
  - Añadir botones de acción:
    - Modificar reserva
    - Realizar/Subir fotos
    - Asignar parking spot

- [✅] Diseñar la lógica de precios en el backend:
  - Marcar precios por rango de días.
  - Diferenciar precios por tipo de vehículo.

- [✅] Cálculo dinámico de precios en la vista `reservation-details.ejs` usando AJAX/fetch

- [ ] Traducir partes de la aplicación que están en español.
